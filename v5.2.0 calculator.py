...
while enter!='kill':
    ...
    if a=='help':
        ...
        print 'To perform addition and output the result "a + b", type "+" or "plus" as the operation'
        ...
        if cal[1] not in ['+', '-', 'x', '/', '^', 'r', '^^', 'plus', 'minus', '*', 'times', 'divided by', 'p', 'rad', 't', 'tetrated to']:
        ...
        if enter=='s':
            ...
            cal[0]=d
            cal[2]=m
        if cal[1]== '+' or cal[1]== 'plus': cal.append(cal[0]+cal[2])
        if cal[1]== '-' or cal[1]== 'minus': cal.append(cal[0]-cal[2]) 
        if cal[1]== 'x' or cal[1]== '*' or cal[1]== 'times': cal.append(cal[0]*cal[2])
